...
const SignupPageLandlord = (props: any) => {
    ...
    const { signUpAsLandlord } = useAuth();
    const router = useRouter();

    const onSubmit = async (data: SignupType) => {
        try {
            await signUpAsLandlord(data.email, data.password, data.name, data.prename, data.birthday, formatted_address, place_id);
...
export default SignupPageLandlord;